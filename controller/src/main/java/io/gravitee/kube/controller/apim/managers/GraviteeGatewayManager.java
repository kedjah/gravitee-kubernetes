...
import io.gravitee.kube.controller.apim.watcher.GraviteeGatewayWatcher;
...
public class GraviteeGatewayManager extends AbstractLifecycleComponent<GraviteeGatewayManager> implements Publisher<WatchActionContext> {
    ...
    public void subscribe(Subscriber<? super WatchActionContext> subscriber) {
        this.gatewayWatcher = this.graviteeGatewayService.getCrdClient().watch(new GraviteeGatewayWatcher(subscriber, graviteePluginsService, graviteeGatewayService));
    }
