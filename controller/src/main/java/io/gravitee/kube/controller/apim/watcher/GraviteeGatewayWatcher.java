 ...
 */
package io.gravitee.kube.controller.apim.watcher;
...
public class GraviteeGatewayWatcher implements Watcher<GraviteeGateway>, GraviteePluginsListener {
    ...
    public GraviteeGatewayWatcher(Subscriber<? super WatchActionContext> subscriber, GraviteePluginsService graviteePluginsService, GraviteeGatewayService graviteeGatewayService) {
    ...
    public void onPluginsUpdate(WatchActionContext<GraviteePlugin> context) {
        ...
        for (GraviteeGateway resource: services) {
            WatchActionContext<GraviteeGateway> derivedContext = new WatchActionContext<>(resource, WatchActionContext.Event.REFERENCE_UPDATED);
