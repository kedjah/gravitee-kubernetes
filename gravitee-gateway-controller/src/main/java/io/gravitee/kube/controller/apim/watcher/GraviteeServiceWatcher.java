...
import io.gravitee.kube.controller.apim.services.impl.WatchActionContext.Event;
...
public class GraviteeServiceWatcher implements Watcher<GraviteeServices>, GraviteePluginsListener, GraviteeGatewayListener {
    ...
    public GraviteeServiceWatcher(Subscriber<? super WatchActionContext> subscriber,
