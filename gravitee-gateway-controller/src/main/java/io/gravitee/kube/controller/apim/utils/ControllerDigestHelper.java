 ...
 */
package io.gravitee.kube.controller.apim.utils;
...
public class ControllerDigestHelper {
    ...
    public static String computeGenericConfigHashCode(Map<String, Object> config) {
        try {
            return computeDigest(Serialization.jsonMapper().writeValueAsString(config));
